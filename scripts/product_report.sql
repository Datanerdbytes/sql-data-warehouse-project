...
/*
================================================================
Product Report: gold.report.customers
================================================================
*/
...
WHERE order_date IS NOT NULL -- only considers valid sales dates
), 
...
SELECT 
    ...
    ROUND(AVG(CAST(sales_amt AS FLOAT) / NULLIF(quantity,0)),1) AS avg_selling_price
FROM base_query
GROUP BY 
    product_key,
    product_name,
...
/*
=======================================================================
   Finaly Query: Combines all product results into one output
=======================================================================
*/
SELECT 
    product_name,
